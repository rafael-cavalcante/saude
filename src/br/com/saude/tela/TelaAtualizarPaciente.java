 ...
 * @author tecin
 */
public class TelaAtualizarPaciente extends javax.swing.JFrame {
    
    private final ControllerPaciente controllerPaciente;
    private Paciente paciente;

    /**
     * Creates new form TelaAtualizarPaciente
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaAtualizarPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new TelaAtualizarPaciente().setVisible(true);
        });
    }
